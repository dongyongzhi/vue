<template>
  <div class="cg-list">
    <el-card shadow="hover">
      ...
      <CgListOperateRecord ref="cgList" :height="clientHeight" @detail="doShowDetail" :fixedQueryRecord="fixedQueryRecord"/>
    </el-card>
  </div>
</template>

<script>
import CgListOperateRecord from './CgListOperateRecord.vue'
import ParentList from '@/views/common-views/components/list'
const Comp = {
  name: 'OperateRecordList',
  components: { CgListOperateRecord },
  mixins: [ParentList],
  data() {
    return {
