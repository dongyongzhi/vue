  ...
  <div :class="mobile || height==0 ? 'cg-form':'cg-form just-v-scroll'" :style="mobile || height==0?'':'height:'+height+'px'">
    <el-form ref="cgForm" v-loading="recordLoading" :model="record" v-cg-form-adjust
      ...
      <el-row :gutter="mobile?0:20">
        <el-col :span="12">
          <el-form-item class="cg-item-select cg-auto-focus" :label="$t('zlkTenantRoomMapping.field.deleteType')" prop="deleteType" :size="$store.state.app.size" >
            <cg-select v-model="record.deleteType" name="deleteType"
                       :dictionary="dictionary.dictDeleteType" :readonly="isDetail" :filterable="false" :allow-create="false" :placeholder="$t('system.message.needValue')" />
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
      ...
      return [
        {
          ...
          title: 'zlkTenantRoomMapping.action.deleteType',
          groupid: 10,
          confirm: '',
          rowProperty: 'nr',
...
const mixins = [Comp]
const mixinContext = require.context('.', false, /CgFormDeleteType-mixin\.(js|vue)$/)
