...
import CgFormDeleteType from './CgFormDeleteType'
const Comp = {
  name: 'DeleteTypeForm',
  components: { CgFormDeleteType },
  mixins: [ParentForm],
  data() {
    return {
      path: 'deleteType',
...
const mixins = [Comp]
const mixinContext = require.context('.', false, /deleteType-mixin\.(js|vue)$/)
