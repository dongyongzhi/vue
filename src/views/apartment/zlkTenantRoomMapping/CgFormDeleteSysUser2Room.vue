...
const Comp = {
  ...
  computed: {
    addtionalActions() {
      return [
        {
          action: 'deleteSysUser2Room',
          icon: 'fa fa-trash-o',
          title: 'zlkTenantRoomMapping.action.deleteSysUser2Room',
          groupid: 10,
          confirm: '',
          rowProperty: 'nr',
          displayProperties: 'ed',
          actionProperty: 'pg',
          appendClass: 'this.deleteSysUser2Room()',
          needRefresh: false
        },
      ]
    },
...
const mixins = [Comp]
const mixinContext = require.context('.', false, /CgFormDeleteSysUser2Room-mixin\.(js|vue)$/)
