...
import CgFormFrozenLock from './CgFormFrozenLock'
const Comp = {
  name: 'FrozenLockForm',
  components: { CgFormFrozenLock },
  mixins: [ParentForm],
  data() {
    return {
      path: 'frozen',
...
const mixins = [Comp]
const mixinContext = require.context('.', false, /frozen-mixin\.(js|vue)$/)
