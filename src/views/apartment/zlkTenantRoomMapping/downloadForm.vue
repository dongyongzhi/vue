<template>
  <div class="cg-form" :class="dialogClass">
    <el-dialog ref="dialog" v-el-drag-dialog :visible.sync="showDialog" top="0px" :class="dialogClass" :close-on-click-modal="false"
      ...
      <CgFormDownloadSysUser2Room ref="cgForm"
...
import CgFormDownloadSysUser2Room from './CgFormDownloadSysUser2Room'
const Comp = {
  name: 'DownloadSysUser2RoomForm',
  components: { CgFormDownloadSysUser2Room },
  mixins: [ParentForm],
  data() {
    return {
      path: 'downloadForm',
...
const mixins = [Comp]
const mixinContext = require.context('.', false, /downloadForm-mixin\.(js|vue)$/)
