...
export default  {
   ...
   getRules: function(obj, rec) {
      ...
      return Object.assign({
         addressId:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('zlkRoom.field.addressId'), trigger: 'blur' }
         ],
         roomName:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('zlkRoom.field.roomName'), trigger: 'blur' }
         ],
