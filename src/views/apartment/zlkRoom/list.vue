<template>
  <div class="cg-list">
    <el-card shadow="hover">
      ...
      <CgListRoom ref="cgList" :height="clientHeight" @detail="doShowDetail" :fixedQueryRecord="fixedQueryRecord"/>
    </el-card>
  </div>
</template>

<script>
import CgListRoom from './CgListRoom.vue'
import ParentList from '@/views/common-views/components/list'
const Comp = {
  name: 'RoomList',
  components: { CgListRoom },
  mixins: [ParentList],
  data() {
    return {
      path: 'list',
