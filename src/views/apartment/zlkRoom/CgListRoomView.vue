...
<template>
  <div :class="joinMode?'cg-join-list':'cg-list'">
    <el-backtop v-if="isTableMode()" ref="cgListBacktop" class="el-backtop" target=".cg-list-roomview .el-table__body-wrapper" :visibility-height="200">
    ...
    <nut-scroller v-if="mobile && isTableMode()"
                  wrapperElement=".cg-list-roomview .el-table__body-wrapper"
                  :isLoading="listLoading"
...
const mixins = [Comp]
const mixinContext = require.context('.', false, /CgListRoomView-mixin\.(js|vue)$/)
