<template>
  <div class="cg-list">
    <el-card shadow="hover">
      ...
      <CgListSelectRoom ref="cgList" :height="clientHeight" @detail="doShowDetail" :fixedQueryRecord="fixedQueryRecord"/>
    </el-card>
  </div>
</template>

<script>
import CgListSelectRoom from './CgListSelectRoom.vue'
import ParentList from '@/views/common-views/components/list'
const Comp = {
  name: 'SelectRoomList',
  components: { CgListSelectRoom },
  mixins: [ParentList],
  data() {
    return {
      path: 'select',
