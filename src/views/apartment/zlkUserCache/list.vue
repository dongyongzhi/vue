<template>
  <div class="cg-list">
    <el-card shadow="hover">
      ...
      <CgListUserCache ref="cgList" :height="clientHeight" @detail="doShowDetail" :fixedQueryRecord="fixedQueryRecord"/>
    </el-card>
  </div>
</template>

<script>
import CgListUserCache from './CgListUserCache.vue'
import ParentList from '@/views/common-views/components/list'
const Comp = {
  name: 'UserCacheList',
  components: { CgListUserCache },
  mixins: [ParentList],
  data() {
    return {
