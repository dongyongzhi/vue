<template>
  <div class="cg-list">
    <el-card shadow="hover">
      ...
      <CgListOplog ref="cgList" :height="clientHeight" @detail="doShowDetail" :fixedQueryRecord="fixedQueryRecord"/>
    </el-card>
  </div>
</template>

<script>
import CgListOplog from './CgListOplog.vue'
import ParentList from '@/views/common-views/components/list'
const Comp = {
  name: 'OplogList',
  components: { CgListOplog },
  mixins: [ParentList],
  data() {
    return {
