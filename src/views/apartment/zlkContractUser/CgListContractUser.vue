...
<template>
  <div :class="joinMode?'cg-join-list':'cg-list'">
    <el-backtop v-if="isTableMode()" ref="cgListBacktop" class="el-backtop" target=".cg-list-contractuser .el-table__body-wrapper" :visibility-height="200">
    ...
    >
      ...
      <el-table-column prop="realName" width="600" :label="$t('zlkContractUser.field.userNo')" align="left" >
    ...
    <nut-scroller v-if="mobile && isTableMode()"
                  wrapperElement=".cg-list-contractuser .el-table__body-wrapper"
...
const Comp = {
  ...
  data() {
    return {
      ...
      queryRecordFields: [],
      formPath: '/apartment/zlkContractUser/record',
      idField: 'id',
      paginationCurrentPage: 1,
      paginationPageSize: this.$store.state.app.device === 'mobile' ? 10 : 30,
      paginationTotalRecords: 0,
      groupByEntityFields: 'contractId',
      listName: 'contractUser',
...
const mixins = [Comp]
const mixinContext = require.context('.', false, /CgListContractUser-mixin\.(js|vue)$/)
