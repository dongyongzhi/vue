...
export default  {
   ...
   getRules: function(obj, rec) {
      ...
      return Object.assign({
         name:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('zlkContract.field.name'), trigger: 'blur' }
         ],
         roomIds:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('zlkContract.field.roomIds'), trigger: 'blur' }
         ],
         userNo:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('zlkContract.field.userNo'), trigger: 'blur' }
         ],
         applyIdNumber:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('zlkContract.field.applyIdNumber'), trigger: 'blur' }
         ],
         applyIdType:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('zlkContract.field.applyIdType'), trigger: 'blur' }
         ],
